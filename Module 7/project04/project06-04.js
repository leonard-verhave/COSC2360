...
selectVehicle.onclick = function() {
   const selectedMake = make.options[make.selectedIndex].text;
   const selectedModel = model.options[model.selectedIndex].text;
   const selectedTrim = trim.options[trim.selectedIndex].text;
